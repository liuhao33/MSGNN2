...
data_path = r'./data/IMDB_processed'
device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')

features, subgraphs,subgraphs_train_val_test, labels, adj, type_mask = load_IMDB_data(prefix = data_path)
...
for rpt in range(repeat):
    ...
    print('\n')
    print('Schema Perturbation Detections')
    print('\n')
...
print('----------------------------------------------------------------')
print('Schema Perturbation Detections Summary')
print('\n')
print('name:', save_postfix)
print('\n')
